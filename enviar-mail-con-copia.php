...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Personalización de Displays Publicitarios';
        $mail->Body    = "Nombre: $nombre<br>Email: $email<br>Teléfono: $telefono<br>País: $pais<br>Comentario: $comentario<br><br>" .
                         "Este mensaje lo creó el cliente a través de https://displayrollup.com/personalizacion-displays-publicitarios. y aceptó los términos y condiciones.";
