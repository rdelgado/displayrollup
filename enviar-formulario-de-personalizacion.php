...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $personalizar = $_POST['personalizar']; // Cambiado de 'pais' a 'personalizar'
    $ciudad = $_POST['ciudad'];
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Personalización de DisplayRollup';
        $mail->Body    = "Nombre: $nombre<br>Email: $email<br>Teléfono: $telefono<br>Personalización: $personalizar<br>Ciudad: $ciudad<br>Comentario: $comentario<br><br>" .
                         "Este mensaje lo creó el cliente a través de https://displayrollup.com. y aceptó los términos y condiciones.";

        $mail->send();
        header('Location: https://displayrollup.com/tipos-terminados-rollups.html');
        exit;
    } catch (Exception $e) {
